...
SECRET_KEY = 'django-insecure-2pnspgq9d4a2b6+(aqc@ry=_e#5_e*$kp)=nyd5(o#r$)22wkh'
...
UNFOLD = {
    "SITE_TITLE": "Books Pointer",
    "SITE_HEADER": "Admin - Books Pointer",
    "SITE_SUBHEADER": "Books Pointer Admin",
}
